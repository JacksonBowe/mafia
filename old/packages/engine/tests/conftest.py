...
def dummy_config(tags=[], roles=[]):
    config = {
        ...
        "roles": {
            ...
            "Mayor": {"max": 1, "weight": 1, "settings": {}},
            "Doctor": {"max": 2, "weight": 1, "settings": {}},
            "Bodyguard": {"max": 2, "weight": 1, "settings": {}},
            "Escort": {"max": 2, "weight": 1, "settings": {}},
            "Sheriff": {"max": 2, "weight": 1, "settings": {}},
            "Investigator": {"max": 2, "weight": 1, "settings": {}},
            "Mafioso": {"max": 2, "weight": 1, "settings": {"promotes": False}},
            "Godfather": {"max": 1, "weight": 1, "settings": {"nightImmune": True}},
            "Consort": {"max": 2, "weight": 1, "settings": {}},
            "Survivor": {"max": 2, "weight": 1, "settings": {}},
            "SerialKiller": {"max": 2, "weight": 1, "settings": {"nightImmune": True}},
        },
    }
