...
export const useMessageStore = defineStore("message", {
    ...
    actions: {
        ...
        info(text: string, meta: MessageMeta, opts?: { ttlMs?: number; ephemeral?: boolean; label?: string }) {
            const msg: Message = {
                id: uid(),
                createdAt: nowMs(),
                kind: "INFO",
                ...
                ...(meta.scope === "game" ? { gameId: meta.gameId, ...(meta.teamId ? { teamId: meta.teamId } : {}) } : {}),
        ...
        user(
            ...
            const msg: Message = {
                ...
                createdAt: nowMs(),
                kind: "USER",
                sender: { type: "USER", userId: sender.userId, ...(sender.displayName ? { displayName: sender.displayName } : {}) },
                text,
                scope: meta.scope,
                channel: meta.channel,
                ...(meta.scope === "menu" && meta.lobbyId ? { lobbyId: meta.lobbyId } : {}),
