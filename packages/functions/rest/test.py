...
def auth_discord():
    ...
    return {
        "uri": "https://discord.com/api/oauth2/authorize?client_id=1199832847012352052&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A9000%2Fauth%2Fdiscord%2Fcallback&scope=identify"
    }
...
def auth_discord_token():
    ...
    jwt.encode(tokens, "secret", algorithm="HS256")
    ...
    return {
        "uri": "https://discord.com/api/oauth2/authorize?client_id=1199832847012352052&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A9000%2F%23%2F&scope=identify"
    }
